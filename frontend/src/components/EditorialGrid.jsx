...
export default function EditorialGrid() {
  ...
  return (
    <div
      ref={sectionRef}
      className="relative max-w-6xl mx-auto grid md:grid-cols-3 gap-10 pb-28"
    >

      {/* 🌫️ GRAIN OVERLAY (very subtle) */}
      ...
      <div className="flex flex-col gap-8">
        ...
        {/* MATERIAL */}
        <div
          className={`bg-[#EFE7DC] p-12 rounded-2xl min-h-[280px] flex flex-col justify-center
          transition-all duration-700 ${
            visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
          }`}
        >
          <h3 className="text-[28px] font-serif text-[#5A0F14] mb-5 leading-snug">
            Material Integrity
          </h3>
          <p className="text-[15px] leading-relaxed text-[#7A6A5A] tracking-wide">
        ...
        {/* QUOTE */}
        <div
          className={`bg-[#6B0F1A] text-[#C89B3C] p-10 rounded-2xl
        ...
        >
          ...
          <p className="text-xs mt-5 text-[#E5D3C2] tracking-[0.2em]">
            — CHARLES EAMES
          </p>
        </div>
